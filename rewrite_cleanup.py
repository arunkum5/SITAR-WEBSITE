...
code = """export async function onRequestPost({ env }) {
...
with open("functions/api/admin/cleanup.js", "w") as f:
    f.write(code)

print("Rewrote cleanup.js to perform sequential, complete deletion.")
